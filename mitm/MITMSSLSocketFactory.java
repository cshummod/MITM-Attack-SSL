...
public final class MITMSSLSocketFactory implements MITMSocketFactory
{
     ...
     */
    //System.getProperty(log , default value);


    public MITMSSLSocketFactory(Principal remoteCN, BigInteger serialno)
...
//*****************************************************************************************************
	...
	//this();
		...
		serverCertificate.setSubjectDN(remoteCN);
		serverCertificate.setSerialNumber(serialno);


		GregorianCalendar date1 = new GregorianCalendar(2015, 1, 1);
		serverCertificate.setValidNotBefore(date1.getTime());

		GregorianCalendar date2 = new GregorianCalendar(2030, 1, 1);
