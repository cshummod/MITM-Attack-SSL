...
//هنا يشيك على ال proxy  لو هو متوافق ولا لا واذا متوافق بيسوي proxiedReuqests++
    public void run()
    {
...
//لو كانت متوافقه بيزود واحد بمتغير proxiedRequests
// متوافقه = يعني لقى كلمة CONNECT اللي يبيها
